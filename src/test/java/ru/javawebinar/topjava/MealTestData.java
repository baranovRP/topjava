...
public class MealTestData {
    ...
    public static final int MEAL_ID_10 = START_SEQ + 12;
    ...
    public static final Meal MEAL_1_USER_2 = new Meal(MEAL_ID_7, LocalDateTime.of(2015, Month.MAY, 25, 10, 0), "Завтрак", 510);
    public static final Meal MEAL_2_USER_2 = new Meal(MEAL_ID_8, LocalDateTime.of(2015, Month.MAY, 25, 20, 0), "Обед", 1510);
    public static final Meal MEAL_3_USER_2 = new Meal(MEAL_ID_9, LocalDateTime.of(2015, Month.MAY, 25, 20, 0), "Ужин", 300);
    public static final Meal MEAL_4_USER_2 = new Meal(MEAL_ID_10, LocalDateTime.of(2015, Month.MAY, 30, 20, 0), "Ужин", 510);
